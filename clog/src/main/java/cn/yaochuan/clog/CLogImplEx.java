...
public class CLogImplEx extends CLogImpl {
	...
	/**
	 * @param filepath Where to save the log file
	 * @param onlytime In a log line, how to show the time, only time or full date&amp;time.
	 *                 True for time, False for date&amp;time
